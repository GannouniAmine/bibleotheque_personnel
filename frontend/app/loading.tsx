...
export default function Loading() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="flex flex-col items-center space-y-6">
      
        <div role="status">
          <svg
            aria-hidden="true"
            className="w-16 h-16 text-gray-300 animate-spin fill-blue-600 dark:text-gray-700"
            viewBox="0 0 100 101"
            fill="none"
        ...
        <h1 className="text-2xl font-semibold text-gray-700 dark:text-gray-200 animate-pulse">
          Chargement en cours...
        </h1>

     
        <div className="w-48 h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
